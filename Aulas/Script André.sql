...
-- 1. MODO 1
SELECT CLIENTE.NOME, CLIENTE.SEXO, ENDERECO.BAIRRO, ENDERECO.CIDADE, TELEFONE.TIPO, TELEFONE.NUMERO -- O que eu quero mostrar
FROM CLIENTE -- De onde vem
	INNER JOIN ENDERECO -- Origem da outra tabela
	ON CLIENTE.IDCLIENTE = ENDERECO.ID_CLIENTE -- Condição
	INNER JOIN TELEFONE -- Origem da outra tabela
	ON CLIENTE.IDCLIENTE = TELEFONE.ID_CLIENTE; -- Condição

-- 2. MODO 2 - DANDO ALIAS (APELIDOS) PARA AS TABELAS
...
/*
SQL é uma linguagem de 4º geração.

DML - DATA MANIPULATION LANGUAGE
DDL - DATA DEFINITION LANGUAGE -- Tipos de dados
...
-- UPDATE
-- 1. Consulte o registro antes de atualizar.
SELECT * FROM CLIENTE
WHERE IDCLIENTE = 7;
...
/* ALTERANDO O TIPO DE UMA COLUNA - MODIFY */
ALTER TABLE PRODUTO
