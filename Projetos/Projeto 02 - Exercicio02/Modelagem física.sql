...
/*  1 - Traga os funcionarios que trabalhem no departamento de filmes OU no
	departamento de roupas*/

/*  2 - O gestor de markentig pediu a lista das funcionárias que trabalham no departamento
	de filmes ou no departamento lar. Ele necessita enviar um email para as colaboradoras
	desses dois setores*/

/*  3 - Traga os funcionarios do sexo masculino ou os funcionarios que trabalham
    no setor jardim*/
...
/*  1 - Traga os funcionarios que trabalhem no departamento de filmes OU no
	...
	SELECT IDFUNCIONARIO AS "Código", NOME, DEPARTAMENTO FROM FUNCIONARIOS
	WHERE DEPARTAMENTO = 'filmes' or DEPARTAMENTO = 'roupas';
	
	SELECT COUNT(*), DEPARTAMENTO
	FROM FUNCIONARIOS
	GROUP BY DEPARTAMENTO
	ORDER BY 1; -- Ordena em ordem crescente pela primeira coluna.
	
/*  2 - O gestor de markentig pediu a lista das funcionárias que trabalham no departamento
	de filmes ou no departamento lar. Ele necessita enviar um email para as colaboradoras
	desses dois setores*/

	--filmes,lar,email,nome
	
	SELECT IDFUNCIONARIO, NOME, DEPARTAMENTO, SEXO, EMAIL AS "E-MAIL" 
	FROM FUNCIONARIOS
...
/*  3 - Traga os funcionarios do sexo masculino ou os funcionarios que trabalham
	...
	--IDFUNCIONARIO, NOME, SEXO, DEPARTAMENTO
	SELECT IDFUNCIONARIO AS "CÓDIGO", NOME, SEXO, DEPARTAMENTO 
	FROM FUNCIONARIOS
